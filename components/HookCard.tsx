...
function hookDesc(niche: string, lang: string): string {
  ...
  if (niche === 'Question Hook') return tr('hookCard', 'question', lang);
  if (niche === 'Warning Hook') return tr('hookCard', 'warning', lang);
  if (niche === 'Curiosity Hook') return tr('hookCard', 'curiosity', lang);
  if (niche === 'Challenge Hook') return tr('hookCard', 'challenge', lang);
  if (niche === 'Mistake Hook') return tr('hookCard', 'mistake', lang);
  if (niche === 'Tutorial Hook') return tr('hookCard', 'tutorial', lang);
  if (niche === 'Hook Tutorial') return tr('hookCard', 'hookTutorial', lang);
  return tr('hookCard', 'engagement', lang);
}
