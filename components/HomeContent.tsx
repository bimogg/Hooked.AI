...
export default function HomeContent() {
  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      {/* ── PROBLEM ── */}
      <section className="bg-[#0a0a0a] text-white px-6 md:px-12 pb-20 border-b border-white/5" style={{ clipPath: 'polygon(0 0, 100% 80px, 100% 100%, 0 calc(100% - 80px))', marginTop: -2, paddingTop: 'calc(80px + 5rem)', paddingBottom: 'calc(80px + 5rem)' }}>
